...
class YouTubeService(BasePlatformService):
    ...
    async def post(
        ...
        **kwargs
        ...
        try:
            ...
            # Check if we should use resumable upload (for videos > 5MB)
            if video_size_mb > 5:
    ...
    async def _simple_multipart_upload(
        ...
        **kwargs
        ...
        """
        Simple multipart upload for small videos (< 5MB).
        Uses multipart/related format that YouTube expects.
        """
...
"""
        ...
        # Part 2: Video binary data
        video_part_header = f"""--{boundary}
...
"""
        ...
        try:
            async with httpx.AsyncClient(timeout=600.0) as client:
                print(f"🎬 YouTube: Uploading video (multipart/related)...")
    ...
    async def _resumable_upload(
        ...
        **kwargs
        ...
        """
        Resumable upload for larger videos (> 5MB).
        ...
        try:
            async with httpx.AsyncClient(timeout=600.0) as client:
                ...
                if init_response.status_code not in [200, 201]:
                    ...
                    print(f"YouTube init failed: {error_text}")
                ...
                print(f"🎬 YouTube: Uploading video data...")
